...
const Add_origin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await authFetch(
        "https://saddlebrown-seahorse-737786.hostingersite.com/api/origin/forms/create",
        {
          method: "POST",
          headers: {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://saddlebrown-seahorse-737786.hostingersite.com/api/origin/forms/${recordId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const fetchShipmentData = async () => {
    ...
    try {
      ...
      // Use authFetch instead of regular fetch
      const response = await authFetch(
        "https://saddlebrown-seahorse-737786.hostingersite.com/api/origin/forms/user"
      );
