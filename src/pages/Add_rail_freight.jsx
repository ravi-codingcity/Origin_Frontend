...
const Add_rail_freight = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://origin-backend-ten.vercel.app/api/railfreight/forms/create",
        {
          method: "POST",
          headers: {
  ...
  const fetchRailFreightData = async () => {
    try {
      const response = await fetch(
        "https://origin-backend-ten.vercel.app/api/railfreight/forms/user",
        {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
          },
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://origin-backend-ten.vercel.app/api/railfreight/forms/${recordId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
